...
orgI = imread('image_00005439_0.png');
...
%         for j=38:112
        for j=38:39
            if (j==38)
                NextFrame = imread('image_00005439_0.png');
            else
                NextFrame = imread('image_00005440_0.png');
            end
...
for i=1:numel(corners)
    plot(corners{i}(2),corners{i}(1),'s');
    plot(newCorners{i}(1),newCorners{i}(2),'r*');
end
hold off;
% newCornerCounter = 1;
% %for j=34:87 %loop throguh all frames
